...
function ActionCard({action}: {action: Action}) {
  ...
  return (
    ...
    <div className='-ml-5 bg-no-repeat bg-center' style={{backgroundImage: getBackground(action.type.protocol), width: 315, height: 373}}>
      <div className={classnames('ml-4 mt-4 font-bold text-white text-center py-2 px-4 rounded-lg text-sm', {
