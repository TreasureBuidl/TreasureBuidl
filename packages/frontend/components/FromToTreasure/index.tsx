...
function FromToTreasure() {
  ...
  return (
    <div className="flex flex-row">
      <div className="bg-darkerBlue border-white border-2 rounded-lg overflow-y-scroll scrollbar scrollbar scrollbar-thumb-offWhite scrollbar-darkBlue"
      ...
      <div className="ml-16 bg-darkerBlue border-white border-2 rounded-lg overflow-y-scroll scrollbar scrollbar scrollbar-thumb-offWhite scrollbar-darkBlue"
        style={{ width: 265, minHeight:  88, maxHeight:  144 }}>
          <div className="flex flex-col mt-2">
            <div className="text-offWhite text-sm text-center">
              To Treasure
